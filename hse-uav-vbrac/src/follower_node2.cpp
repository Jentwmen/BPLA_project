...
int main(int argc, char **argv) {
  ...
  ros::Subscriber sub = nodeHandle.subscribe("/uav0/mavros/local_position/pose",
                                             10, leadposeCallback);
  ros::Subscriber follower_pos=nodeHandle.subscribe("/uav2/mavros/local_position/pose", 10, poseCallback);
  ...
  set_mode_client =
      nodeHandle.serviceClient<mavros_msgs::SetMode>("/uav2/mavros/set_mode");
